...
export default function BigDolar({dataDolar}: Props){
    return(<article className="grid grid-cols-4 text-center gap-8 border-2 py-4">
        <div>
            <h4 className="font-bold text-[#0250c9]">Dólar {dataDolar[0].name}</h4>
        ...
        <div>
            <h4 className="font-bold text-[#0250c9]">Dólar {dataDolar[1].name}</h4>
            <div className="grid grid-cols-2">
                <span className="text-xs text-[#5a5a5a]">Compra</span>
                <span className='text-xs text-[#5a5a5a]'>Venta</span>
        ...
        <div>
            <h4 className="font-bold text-[#0250c9]">Dólar {dataDolar[2].name}</h4>
        ...
        <div>
            <h4 className="font-bold text-[#0250c9]">Dólar {dataDolar[3].name}</h4>
            <div className="grid grid-cols-1">
                <span className='text-xs text-[#5a5a5a]'>Venta</span>
        ...
        <div>
            <h4 className="font-bold text-[#0250c9]">Dólar {dataDolar[4].name}</h4>
            <div className="grid grid-cols-1">
                <span className='text-xs text-[#5a5a5a]'>Venta</span>
        ...
        <div>
            <h4 className="font-bold text-[#0250c9]">Dólar {dataDolar[5].name}</h4>
            <div className="grid grid-cols-1">
                <span className='text-xs text-[#5a5a5a]'>Venta</span>
        ...
        <div>
            <h4 className="font-bold text-[#0250c9]">Dólar {dataDolar[6].name}</h4>
            <div className="grid grid-cols-1">
                <span className='text-xs text-[#5a5a5a]'>Venta</span>
        ...
        <div>
            <h4 className="font-bold text-[#0250c9]">Euro</h4>
            <div className="grid grid-cols-2">
                <span className="text-xs text-[#5a5a5a]">Compra</span>
                <span className='text-xs text-[#5a5a5a]'>Venta</span>
