  ...
  return(
        <div className="w-full grid grid-cols-5 text-center gap-4 border-b-2 py-4 relative">
          <div className="flex gap-2 items-center text-left">
                ...
                <Image src={Robotize} alt='Icono' width={50} height={50} className="rounded-lg"/>
          ...
          <div className="gap-2 text-xs text-white">
            {
              ...
              : <span className="bg-robotize px-2 rounded-lg">En redaccion</span>
            }
          </div>
          {
            changeTitle 
          ...
          <div>
            <Link href={`/admin/${titleURL}`} className="border-b-robotize border-b-2 w-1/3 text-center">Ver nota</Link>
          </div>
          {
