        ...
        <section>
            {
                ...
                ? <>
                    <form className="py-4 flex flex-col gap-4" onSubmit={handelSubmit}>
                        ...
                        <h4>Titulo:</h4>
                        <textarea name='title'  value={article.title} cols={30} rows={2} onChange={handleChange} className="text-4xl lg:text-2xl font-bold text-center max-sm:text-2xl border-2 border-[#441eae] p-2"/>
                        {/* Bajada */}
                        ...
                        <h4>Nota Completa:</h4>
                        <p onClick={makeTextStrong} className="bg-[#441eae] text-white mt-2 px-4 py-2 rounded-lg w-1/12 cursor-pointer">Negritas</p>
                        <textarea name='content'  value={article.content} cols={30} rows={15} onChange={handleChange} className="border-2 border-[#441eae] p-2"/>
                        {/* TAGS */}
                        <h4>Tags:</h4>
                        <textarea name="tags" value={article.tags} cols={30} rows={2} onChange={handleTags} className="border-2 border-[#441eae] p-2"/>
                        <br />
                        <button className="bg-[#441eae] text-white w-1/6 mx-auto py-2 rounded-lg">Modificar</button>
                    </form>
                </>
